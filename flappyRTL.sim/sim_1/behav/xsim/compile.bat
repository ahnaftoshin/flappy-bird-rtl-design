...
REM
REM Generated by Vivado on Mon Dec 08 19:52:38 -0500 2025
...
echo "xvhdl --incr --relax -prj flappy_processor_tb_vhdl.prj"
call xvhdl  --incr --relax -prj flappy_processor_tb_vhdl.prj -log xvhdl.log
